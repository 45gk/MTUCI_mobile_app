...
import com.example.mtuci_mobile_app.databinding.WidgetBinding

/**
 * A simple [Fragment] subclass as the default destination in the navigation.
 */
class Widget : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = WidgetBinding.inflate(inflater, container, false)
        return binding.root
...
//        };
        binding.backButtonLogin.setOnClickListener {
            findNavController().navigate(R.id.action_widget_to_profile2)
        };
